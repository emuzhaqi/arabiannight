...
function UserBadge() {
  ...
  return (
    <div style={{
      ...
      <span style={{ fontFamily: "'Cinzel', serif", fontSize: '0.75rem', letterSpacing: '0.15em', color: '#c9921a' }}>
        {username}
      </span>
      <button
...
function BackLink() {
  return (
    <Link to="/" className="bazaar-back-link">
      &#8592; Agrabah
    </Link>
  )
}
    ...
    <div className="page">
      ...
      <main className="content">
        ...
        <div className="title-container">
          ...
          <h1 className="title">The Grand Bazaar</h1>
          <div className="title-subtitle">&#x202E;&#x633;&#x648;&#x642;&#x202C; &bull; Merchants&apos; Quarter &bull; &#x202E;&#x633;&#x648;&#x642;&#x202C;</div>
        </div>
        ...
        <p className="tagline">A thousand wares, a thousand secrets...</p>
      </main>
